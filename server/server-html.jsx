...
// oniture config that needs to be called before loading in there external js
...
(window,document,"script","5591df2ac615601b4e00000b");
  ...
  // var _gaq = _gaq || [];
  // _gaq.push(['_setAccount', 'UA-4967829-1']);
  //
  // (function() {
  ...
  ga.l = +new Date();
  ga('create', 'UA-4967829-1', 'auto');  // Replace with your property ID.
  ...
  (function(d){
      ...
      p.onload = p.onreadystatechange = function () {
        window.adSetAdURL('http://www.stylemepretty.com/_uac/adpage.html');
        window.adSetMOAT("1");
      };
      f.parentNode.insertBefore(p, f);
  }(document));
  ...
  (function() {
    ...
    //Async load any non critical path css
    var handleAsyncCssLoad = function() {
      loadCSS('//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.min.css');
    };
    var raf = requestAnimationFrame || mozRequestAnimationFrame || webkitRequestAnimationFrame || msRequestAnimationFrame;
    if (raf) raf(handleAsyncCssLoad);
    else window.addEventListener('load', handleAsyncCssLoad);
  })();`;

export default function ServerHTML({ body, assets, locale, title, description, meta, links }) {
  return (
    <html lang={ locale }>
      <head>
        <meta
        ...
        <meta property='og:site_name' content='Style Me Pretty The Vault' />
        { meta }
        <meta name='twitter:card' content='summary_large_image' />
        <meta name='twitter:description' content='Explore millions of stunning wedding images to help inspire and plan your perfect day.' />
        <meta name='twitter:site' content='@stylemepretty' />
        { links }
